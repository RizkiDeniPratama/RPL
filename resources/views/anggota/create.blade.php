                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('NoAnggotaM') is-invalid @enderror" id="NoAnggotaM" name="NoAnggotaM" value="{{ old('NoAnggotaM') }}" required />
                                    @error('NoAnggotaM')
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('NoTelpHp') is-invalid @enderror" id="NoTelpHp" name="NoTelpHp" value="{{ old('NoTelpHp') }}" required />
                                    @error('NoTelpHp')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
