...
<body>
    ...
    <div class="report-title">Laporan Anggota Perpustakaan</div>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th class="col-kode">NIP/NIS</th>
                    <th class="col-udc">Jenis Anggota</th>
                    <th class="col-pengarang">Nama Anggoota</th>
                    <th class="col-penerbit">Tanggal Lahir</th>
                    <th class="col-udc">Jenis Kelamin</th>
                    <th class="col-isbn">Kelas/Pekerjaan</th>
                    <th class="col-judul">Alamat</th>
                    <th class="col-stok">No Telp</th>
                </tr>
            </thead>
            <tbody>
 @foreach ($anggota as $index => $item)
        <tr>
            ...
            <td class="text-center">
                {{ $item->TanggalLahir ? \Carbon\Carbon::parse($item->TanggalLahir)->format('d-m-Y') : '-' }}
            </td>
